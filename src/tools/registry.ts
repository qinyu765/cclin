 ...
 *   3. 提供 createExecuteTool() 生成符合 ExecuteTool 签名的函数
 */

import type { ToolDefinition, ExecuteTool } from '../types.js'
 ...
 * const executeTool = registry.createExecuteTool()  // 传给 ReAct 循环
 * ```
 */
